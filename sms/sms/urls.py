...
urlpatterns = [
    ...
    path('start-report-generation/<int:report_id>/', views.start_report_generation, name='start_report_generation'),
    path('check-task-status/<str:task_id>/', views.check_task_status, name='check_task_status'),
    path('download-zip/<str:filename>/', views.download_zip_file, name='download_zip_file'),
    path('reports_test/', views.report_files_list, name='report_files_list'),
    path('reports_test/<int:report_id>/', views.report_detail, name='report_detail'),
    path('reports_test/<int:report_id>/download/<str:filename>/', views.download_report_file, name='download_report_file'),
    ...
    path('report_insight3/<int:report_id>/', views.get_report_insight_new, name='report_insight3'),
