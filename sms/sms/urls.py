...
urlpatterns = [
    ...
    path('download_report3/<int:report_id>/', views.download_campaign_report3, name='report_download3'),
    ...
    path('template-linkage/download/<str:button_name>/<str:start_date>/<str:end_date>/<str:report_id>/', views.download_linked_report, name='download_linked_report'),
