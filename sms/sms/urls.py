...
urlpatterns = [
    ...
    path("zip-reports/", views.report_zip_list, name="report_zip_list"),
    path("get_insights/<int:report_id>/", views.get_insights, name="get_insights"),
    path("download-zip/<str:file_name>/", views.download_zip_files, name="doget_insightswnload_zip_files"),
